      ...
      <div className="col-lg-7 h-auto mb-30 text-align-center">
        <div className="h-100 bg-light p-30">
          ...
          {products.map((productData) => {
            return (
              <>
                <h3 className="text-left" key={productData.id}>{productData.name}</h3>
                ...
                <h3 className="font-weight-semi-bold text-left mb-4">
                  $150.00
                </h3>
                ...
                <NavLink
                  className="btn btn-outline-danger py-2 px-4 mt-5 animate__animated animate__fadeInUp"
                  to={productData.shopLink}
                >
                  Shop Now
                </NavLink>
              </>
            ...
            <div className="tab-content">
              ...
              <div className="tab-pane fade" id="tab-pane-3">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <h4 className="mb-4">Leave NavLink review</h4>
                    <small>
